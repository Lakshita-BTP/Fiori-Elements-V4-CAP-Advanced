...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PassengerListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onThePassengerListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePassengerListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onThePassengerListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onThePassengerListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onThePassengerListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onThePassengerListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onThePassengerListGenerated.onFilterBar().iExecuteSearch();
            Then.onThePassengerListGenerated.onTable(defaultTableId).iCheckRows();
            When.onThePassengerListGenerated.onTable(defaultTableId).iPressRow(0);
